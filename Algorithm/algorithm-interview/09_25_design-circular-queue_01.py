...
print('obj = MyCircularQueue(3)', 'queue: ' + str(obj.queue), '\nfront ' + str(obj.front), 'rear: '+ str(obj.rear), '\n')
param_1 = obj.enQueue(1)
print('enQueue(1)', 'queue: ' + str(obj.queue), '\nfront ' + str(obj.front), 'rear: '+ str(obj.rear), '\n')
param_2 = obj.enQueue(2)
print('enQueue(2)', 'queue: ' + str(obj.queue), '\nfront ' + str(obj.front), 'rear: '+ str(obj.rear), '\n')
param_3 = obj.enQueue(3)
print('enQueue(3)', 'queue: ' + str(obj.queue), '\nfront ' + str(obj.front), 'rear: '+ str(obj.rear), '\n')
param_4 = obj.enQueue(4)
print('enQueue(4)', 'queue: ' + str(obj.queue), '\nfront ' + str(obj.front), 'rear: '+ str(obj.rear), '\n')
param_5 = obj.Rear()
print('Rear()', 'queue: ' + str(obj.queue), '\nfront ' + str(obj.front), 'rear: '+ str(obj.rear))
print('Rear()', 'result: ' + str(param_5), '\n')
param_6 = obj.isFull()
print('isFull()', 'queue: ' + str(obj.queue), '\nfront ' + str(obj.front), 'rear: '+ str(obj.rear))
print('isFull()', 'result: ' + str(param_6), '\n')
param_7 = obj.deQueue()
print('deQueue()', 'queue: ' + str(obj.queue), '\nfront ' + str(obj.front), 'rear: '+ str(obj.rear), '\n')
